...
public class GetTracksByAlbum {
	public static ArrayList<Music> getTracksByAlbum(Activity activity,
			long album_id) {
		ArrayList<Music> musics = new ArrayList<Music>();
		ContentResolver mResolver = activity.getContentResolver();
		String[] projection = { MediaStore.Audio.Media.TITLE,
				MediaStore.Audio.Media._ID, MediaStore.Audio.Media.ARTIST_ID,
				MediaStore.Audio.Media.ALBUM, MediaStore.Audio.Media.DURATION,
				MediaStore.Audio.Media.ARTIST, MediaStore.Audio.Media.ALBUM_ID,
				MediaStore.Audio.Media.DATA, MediaStore.Audio.Media.TITLE_KEY };
		String selection = MediaStore.Audio.Media.ALBUM_ID + "=" + album_id
